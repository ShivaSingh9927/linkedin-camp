...
export function FAQV2() {
  ...
  return (
    <section id="faq" className="py-24 sm:py-32 bg-white relative overflow-hidden">
      {/* Background glows */}
      <div className="absolute top-1/4 left-1/4 w-[400px] h-[400px] bg-indigo-500/[0.02] rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-[300px] h-[300px] bg-purple-500/[0.02] rounded-full blur-[120px] pointer-events-none" />
          ...
          {faqs.map((faq, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className="text-base font-bold text-slate-900 pr-4 group-hover:text-indigo-600 transition-colors duration-200">
                    {faq.question}
                  </span>
                  <motion.div
