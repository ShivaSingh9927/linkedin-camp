...
const FEATURES = [
  {
    id: "ai-messages",
    label: "Qampi AI Messages",
    icon: Bot,
    description: "Our AI is fine-tuned on your writing style and company context. Every message sounds like you — not a template. Free users get 25 messages/week with Qampi Fast.",
  ...
  },
  {
    ...
    label: "Qampi Pro",
    icon: Brain,
    description: "Unlock our largest AI models for deep prospect research, intent signal detection, and multi-layered personalization. Qampi Pro doesn't just read profiles — it understands them.",
  ...
  },
  {
    ...
    icon: MessageSquare,
    description: "AI-powered follow-up sequences that adapt based on prospect behavior. If they viewed your profile but didn't reply, Qampi adjusts the next message accordingly.",
