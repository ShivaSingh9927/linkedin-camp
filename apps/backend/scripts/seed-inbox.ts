        ...
        await prisma.message.createMany({
            data: [
                ...
                },
                {
                    ...
                    leadId: sarah.id,
                    direction: 'SENT',
                    content: `Great to hear! We've built a LinkedIn campaign engine that automates outreach with AI-personalized messages. Think of it as Waalaxy but with better personalization and a built-in CRM.\n\nKey features:\n• Smart lead extraction from LinkedIn\n• AI-written personalized messages\n• Multi-step campaign workflows\n• Built-in inbox for managing replies\n\nWould a 15-min demo work this week?`,
                    source: 'MANUAL',
                    sentAt: daysAgo(3),
                },
                {
        ...
        await prisma.message.createMany({
            data: [
                ...
                },
                {
                    ...
                    leadId: priya.id,
                    direction: 'RECEIVED',
                    content: `Hey! We actually just started exploring automation tools. What makes yours different from Waalaxy or Lemlist?`,
                    source: 'LINKEDIN_SYNC',
                    sentAt: daysAgo(6),
                },
                {
